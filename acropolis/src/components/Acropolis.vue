<template>
  <div>
    <div v-if="!isLoggedIn">
      <h3 style="color: #fff; text-align: center; padding: 5px; max-width: 200px; margin: 0 auto;">Welcome to Acropolis MMORPG Beta Testing! </h3>
      <p style="color: #fff; text-align: center; border: 1px solid white; padding: 5px; max-width: 200px; margin: 0 auto;" @click='initGame'> Click here to Login!</p>
    </div>
    <div v-else>
 <div  style="text-align: center; margin: 25px auto">
  ...
  <p style="color: #fff; text-align: center;">
    The first time you login you will receive a reward of 100 $ACR, 
    be wise because that's the only currency that will be used inside and outside the game. 
  </p>
  <h3 style="color: #fff;text-align: center;">If you can't see the game screen refresh and login again!</h3>
    <p style="color: #fff; text-align: center;">
      Server stats. 
